...
code = Entry(frame,width=25,fg='#57a1f8',border=0,bg="white",font=('Microsoft YaHie UI Light',11))
...
Button(frame,width=39,pady=7,text='Submit',bg='#57a1f8',fg='white',border=0,command=signin).place(x=35,y=204)
